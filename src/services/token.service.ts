 ...
 */
const saveToken = async (token: string, userId: ObjectId, expires: Moment, type: string) => {
 ...
 */
const generateAuthTokens = async (user: any): Promise<{ access: { token: string; expires: Date }; refresh: { token: string; expires: Date } }> => {
